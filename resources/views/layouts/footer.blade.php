...
<div data-simplebar class="h-100">
    <div class="p-4">
        ...
        <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Color
            Scheme</h6>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        <input class="form-check-input"
                            type="radio" name="data-layout-mode"
                            ...
                            <span class="d-flex gap-1 h-100">
                                ...
                                <span class="flex-grow-1">
                                    <span
                                        class="d-flex h-100 flex-column">
                                        <span
                                            class="bg-soft-light d-block p-1"></span>
                                        <span
        ...
        <div id="layout-position">
            <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Layout
                Position</h6>
            <p class="text-muted">Choose Fixed or Scrollable
                Layout Position.</p>
        ...
        <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Topbar
            Color</h6>
        ...
        <div id="sidebar-size">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <h5 class="fs-13 text-center mt-2">Small
                        (Icon View)</h5>
                </div>
        ...
        <div id="sidebar-view">
            <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Sidebar
                View</h6>
            <p class="text-muted">Choose Default or Detached
                Sidebar view.</p>
